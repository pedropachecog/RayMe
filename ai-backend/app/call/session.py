...
# A successful selection switch can stop old/new playout, retire the old peer,
# cancel its turn, and release the old prompt lease in sequence. Keep the
# browser decision budget derived from all five bounded steps plus transport
# and status-polling margin.
CALL_PEER_SWITCH_MAX_SEQUENTIAL_CLEANUP_STEPS = 5
CALL_PEER_SWITCH_DECISION_TIMEOUT_SECONDS = (
    CALL_SWITCH_CLEANUP_STEP_TIMEOUT_SECONDS
    * CALL_PEER_SWITCH_MAX_SEQUENTIAL_CLEANUP_STEPS
    + 1.0
)
