...
TTS_ENGINE_METADATA: tuple[TtsEngineMetadata, ...] = (
    ...
    TtsEngineMetadata(
        ...
        runtime_evidence="Phase 9 accepted Faster Qwen3-TTS v0.3.2 on RTX 3060: 368.9 ms median native first audio, 1.46 RTFx, and 50-turn hot-process stability without progressive degradation.",
        requires_transcript=True,
        supports_streaming=True,
        quality_notes="1.7B-Base full-ICL voice cloning requires the saved reference audio and its matching transcript; production calls use bounded native streaming without whole-synthesis fallback.",
    ),
    TtsEngineMetadata(
        id="luxtts",
        label="LuxTTS",
