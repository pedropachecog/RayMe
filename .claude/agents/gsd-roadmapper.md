...
Reference full template: `D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/templates/state.md`.
