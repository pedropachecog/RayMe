...
Use template from `D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
