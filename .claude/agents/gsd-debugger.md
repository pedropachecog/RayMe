...
<required_reading>
@D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Pedro/Repos/Program/RayMe/.claude
                  → checks D:/Pedro/Repos/Program/RayMe/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done
                  → writes to D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/hooks/
...
@D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
