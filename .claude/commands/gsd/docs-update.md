...
<execution_context>
@D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/workflows/docs-update.md end-to-end.
