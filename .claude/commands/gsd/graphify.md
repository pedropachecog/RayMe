...
Knowledge graph is disabled. To activate:
  ...
  node D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
