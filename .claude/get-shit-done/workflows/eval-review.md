...
```bash
AUDITOR_MODEL=$(node "D:/Pedro/Repos/Program/RayMe/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/Pedro/Repos/Program/RayMe/.claude/agents/gsd-eval-auditor.md for instructions.
