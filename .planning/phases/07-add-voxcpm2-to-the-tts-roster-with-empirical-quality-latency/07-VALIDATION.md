...
| 07-05-* | Promotion decision | 5 | REQ-45, REQ-A3 | T-07-06 | Promotion/caveat/unavailable outcome is backed by scenario matrix, WAVs, VRAM soak, call-flow proof, and manual CSV | artifact + manual | `python -m pytest .planning/phases/00-measurement-gate/probes/test_tts_scenario_matrix.py -q` plus saved live evidence | No | pending |
