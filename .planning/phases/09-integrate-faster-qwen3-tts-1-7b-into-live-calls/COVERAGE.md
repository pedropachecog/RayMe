...
| `chunk_size=3` | INTEGRATE | Targets native hot first-chunk latency inside the 500 ms gate without the two-step allocator increase, while RayMe retains its separate 600 ms startup audio buffer. |
