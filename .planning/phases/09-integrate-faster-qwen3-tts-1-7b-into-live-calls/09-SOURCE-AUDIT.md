...
| REQ | REQ-22 | Truthful saved Qwen engine, exact transcript/reference, compatibility identity | 09-01–09-09, 09-12–09-15 | COVERED | Includes explicit delete→prompt eviction and an explicitly selected transport-fixture preflight. |
...
| AI-SPEC | H-02/C-08 | Assumed-authorized upload with contained asset, byte/hash/transcript integrity, private handling, delete eviction, and leak self-test | 09-04, 09-06–09-09, 09-12–09-15 | COVERED | The selected sample stays RayMe-contained; a generated non-person fixture is transport-only when explicitly selected and never a metadata fallback. |
| UI-SPEC | — | Canonical engine identity, independent readiness, assumed-authorized metadata-free upload, row-scoped prepare/synthesis/retry, truthful technical call gate, fixed live-region/focus/reduced-motion/44px contracts | 09-08–09-09, 09-15 | COVERED | Production tasks name EndpointSettingsPanel, VoiceLibraryRow/List, Voice Lab, and call route; Playwright is the wave acceptance and deployed browser gate. |
...
| PROHIBITION | P-01 | No arbitrary/uncontained reference | 09-04, 09-06–09-07, 09-09, 09-13–09-15 | COVERED | Upload is assumed authorized; Phase 09 requires only RayMe-owned containment, valid bytes, matching hashes/transcript and alignment. Missing policy metadata cannot select a fixture; any deterministic mechanical fixture is explicitly selected transport evidence only. |
