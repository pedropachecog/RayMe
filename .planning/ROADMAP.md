...
- [x] 03.1-04-PLAN.md - Client helper/unit stabilization for same-origin wrappers, mic/audio helpers, missing-chunks reconnect backfill, and call state
- [x] 03.1-05-PLAN.md - Browser call route/component stabilization for startup, reconnect PCM continuity, controls, visualizer states, and mobile layout
- [x] 03.1-06-PLAN.md - Focused local call regression baseline, missing-chunks proof, and runtime-sensitive evidence artifacts
- [ ] 03.1-07-PLAN.md - Canonical OMEN deployment, dual-engine live desktop smoke, and Android Chrome product-owner missing-chunks acceptance
...
- [x] 09-01-PLAN.md - Immutable dependency/package provenance and truthful 1.7B roster identity (Wave 1)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 09-02-PLAN.md - Versioned worker protocol and supervised native full-ICL stream/cancel adapter (Wave 2)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 09-03-PLAN.md - Local one-hot readiness plus fake slow-stream/cancel CallSession contract (Wave 3)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 09-04-PLAN.md - Blocking canonical OMEN real saved-voice/CallSession/WebRTC hardware tracer (Wave 4)
...
- [x] 09-10-PLAN.md - Incremental slow-LLM segment pump and terminal-authorized persistence (Wave 7)

**Wave 8** *(blocked on Wave 7 completion)*

- [x] 09-12-PLAN.md - Twenty-scenario manifest, pinned local speaker scorer, and adversarial verifier self-test (Wave 8)

**Wave 9** *(blocked on Wave 8 completion)*

- [x] 09-13-PLAN.md - Production-path 20-scenario/50-turn OMEN evidence runner construction (Wave 9)

**Wave 10** *(blocked on Wave 9 completion)*

- [x] 09-14-PLAN.md - Final canonical deploy and exact-commit runtime/call/STT core evidence (Wave 10)
...
- [x] 09.1-02-PLAN.md — Observe OMEN read-only, then freeze sanitized evidence and verifier contracts (Wave 2)
- [x] 09.1-03-PLAN.md — Persist the typed prompt profile and Roleplay default independently (Wave 2)
- [x] 09.1-04-PLAN.md — Migrate the nullable truthful thread example snapshot independently (Wave 2)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 09.1-05-PLAN.md — Compose exact structured prompts and model-aware Qwen/Generic requests (Wave 3)
- [x] 09.1-09-PLAN.md — Deliver the typed Prompt & Generation Settings surface (Wave 3)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 09.1-06-PLAN.md — Unify Send, Regenerate, Swipe, and Continue on guarded generation (Wave 4)
- [x] 09.1-07-PLAN.md — Unify Call offers/turns while preserving early playback and Interrupt (Wave 4)
- [x] 09.1-10-PLAN.md — Finish app-local typography and responsive Settings states (Wave 4)
- [x] 09.1-11-PLAN.md — Deliver Character Editor macro, inheritance, example, and PHI guidance (Wave 4)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 09.1-08-PLAN.md — Expose the same-origin non-mutating exact prompt preview API (Wave 5)
- [x] 09.1-12-PLAN.md — Preserve typed generation failures and metadata-only retry feedback (Wave 5)

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 09.1-13-PLAN.md — Deliver the accessible responsive exact Prompt Inspector (Wave 6)
